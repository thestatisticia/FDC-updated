...
3. Endesha `yarn tutorial:beginner -- --dry-run --explain` kwa mafunzo ya kina.
4. Fanya kazi na `utils/simpleFdc.ts` na ongeza majaribio yako miaka ukitumia `test/simpleFdc.test.ts`.
